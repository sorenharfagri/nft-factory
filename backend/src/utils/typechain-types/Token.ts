...
export interface TokenInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: "mintMany", values: [BytesLike]): string;
...
export interface Token extends BaseContract {
  ...
  mint: TypedContractMethod<
    [to: AddressLike],
    [[bigint, string] & { tokenId: bigint; tokenUri: string }],
    "nonpayable"
  >;

  mintMany: TypedContractMethod<[holders: BytesLike], [void], "nonpayable">;
  ...
  ): TypedContractMethod<[holders: BytesLike], [void], "nonpayable">;
  getFunction(
